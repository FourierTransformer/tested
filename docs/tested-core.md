...
Below are examples of using `tested_core` to run tests, and at the [bottom of the page](#type-definition-reference), we also have the full Teal type definitions for all of the values that get returned.
